...
export const NavigationLinks = ({ closeMenu }) => {
  return (
    <ul className="navigation__links">
      <li>
        <NavLink to="/" className={({ isActive }) => "gray-text navigation__link" + (isActive ? " main-active" : "")} onClick={closeMenu}>
          Main
        </NavLink>
      </li>
      <li>
      ...
      <li>
        <NavLink to="/experience" className={activeNavLink} onClick={closeMenu}>
          Experience
        </NavLink>
      </li>
      <li>
